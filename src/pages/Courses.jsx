  ...
  const certificateCourses = [
    {
      id: 1,
      number: 1,
      title: "Fundamentals, Windows, Internet",
      category: "Office Systems",
      skills: "Operating Systems, Web Browsing, Digital Literacy",
      duration: "4 Weeks",
    },
    {
      id: 2,
      number: 2,
      title: "Fundamentals, Windows, Internet, HTML",
      category: "Programming & Web",
      skills: "OS Basics, Web Browsing, Web Page Creation",
      duration: "6 Weeks",
    },
    {
      id: 3,
      number: 3,
      title: "Basic Programming, FoxPro",
      category: "Databases & ERP",
      skills: "Procedural Logic, DB Commands, Legacy Systems",
      duration: "6 Weeks",
    },
    {
      id: 4,
      number: 4,
      title: "MS-Word, MS-PowerPoint, MS-Excel",
      category: "Office Systems",
      skills: "Docs Drafting, Slide Design, Data Sheets",
      duration: "6 Weeks",
    },
    {
      id: 5,
      number: 5,
      title: "MS-Word, MS-PowerPoint, MS-Excel, MS-Access",
      category: "Office Systems",
      skills: "Office Suite, Desktop Relational Databases",
      duration: "8 Weeks",
    },
    {
      id: 6,
      ...
      category: "Programming & Web",
      skills: "Pointers, Memory Ops, OOP Paradigms",
      duration: "8 Weeks",
    },
    {
      id: 7,
      ...
      title: "Visual Basic",
      category: "Programming & Web",
      skills: "GUI App Design, Event Handling, Visual Studio",
      duration: "6 Weeks",
    },
    {
      id: 8,
      ...
      category: "Databases & ERP",
      skills: "SQL, DBMS Schemas, PL/SQL, Indexes",
      duration: "8 Weeks",
    },
    {
      id: 9,
      number: 9,
      title: "Java Programming & Enterprise MVC Systems",
      category: "Programming & Web",
      skills:
        "JDK, Core Java, Multi-threading, OOP, Spring Boot, Microservices",
      duration: "8 Weeks",
    },
    {
      id: 10,
      number: 10,
      title: "PageMaker, CorelDraw",
      category: "Design & Animation",
      skills: "Vector Art, Desktop Publishing, Print Layouts",
      duration: "8 Weeks",
    },
    {
      id: 11,
      number: 11,
      title: "Photo Shop Mastery",
      category: "Design & Animation",
      skills: "Photo Editing, Layers, Retouching, Digital Art",
      duration: "6 Weeks",
    },
    {
      id: 12,
      ...
      category: "Programming & Web",
      skills: "Semantic HTML5, CSS Styling, Responsive Design",
      duration: "4 Weeks",
    },
    {
      id: 13,
      ...
      category: "Design & Animation",
      skills: "2D Vector Animation, Timelines, ActionScript",
      duration: "8 Weeks",
    },
    {
      id: 14,
      number: 14,
      title: "Tally ERP (General)",
      category: "Databases & ERP",
      skills: "Financial Ledger Accounting, GST, Inventory",
      duration: "6 Weeks",
    },
    {
      id: 15,
      number: 15,
      title: "Tally 9.0 (TCDS Certification)",
      category: "Databases & ERP",
      skills: "Advanced Ledger Audits, Taxation, Financials",
      duration: "8 Weeks",
    },
    {
      id: 16,
      number: 16,
      title: "Tally 9.0 (Tally Academy)",
      category: "Databases & ERP",
      skills: "National Curriculum, Multi-ledger Accounting",
      duration: "8 Weeks",
    },
    {
      id: 17,
      number: 17,
      title: "Active Server Page (ASP - Full Set)",
      category: "Programming & Web",
      skills: "Dynamic Web Services, Session Cache, SQL Links",
      duration: "8 Weeks",
    },
    {
      id: 18,
      ...
      category: "Programming & Web",
      skills: "C# Equivalent, .NET Framework, Desktop Apps",
      duration: "8 Weeks",
    },
    {
      id: 19,
      number: 19,
      title: "Active Server Page .NET",
      category: "Programming & Web",
      skills: "ASP.NET MVC, Web APIs, SQL Server integrations",
      duration: "8 Weeks",
    },
    {
      id: 20,
      ...
      category: "Programming & Web",
      skills: "Windows Script Host, Automations, Server Scripts",
      duration: "4 Weeks",
    },
    {
      id: 21,
      ...
      category: "Programming & Web",
      skills: "DOM, Dynamic Operations, Async APIs, AJAX",
      duration: "6 Weeks",
    },
    {
      id: 22,
      number: 22,
      title: "Macromedia Director",
      category: "Design & Animation",
      skills: "Interactive CD-ROM Publishing, Lingo Scripts",
      duration: "8 Weeks",
    },
    {
      id: 23,
      number: 23,
      title: "Maya (3D Animation & Modeling)",
      category: "Design & Animation",
      skills: "3D Polygons, Rigging, Textures, Render Engine",
      duration: "12 Weeks",
    },
    {
      id: 24,
      number: 24,
      title: "Python Programming & AI Foundation",
      category: "Programming & Web",
      skills:
        "Python Syntax, Data Structures, Web Scrapers, Pandas, NumPy, OpenAI API Integration",
      duration: "8 Weeks",
    },
    {
      id: 25,
      ...
      category: "Programming & Web",
      skills:
        "React.js, Node.js, Express.js, MongoDB, REST APIs, Git, Vercel Hosting",
      duration: "12 Weeks",
    },
  ];
...
==================================================`;
  ...
  const getCourseWaText = (
    course,
  ) => `Hi Saishnaa Team, I am interested in joining the ${course.title} certificate course.
...
Please share the schedule and admission requirements!`;
  ...
  const getCourseEmailSubject = (course) =>
    `Inquiry: ${course.title} Certificate Course`;

  const getCourseEmailBody = (
    course,
  ) => `==================================================
🎓 COURSE INQUIRY - SAISHNAA ACADEMY
==================================================
  ...
  return (
    <div className="page-fade-in">
      ...
      <section
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(77, 30, 163, 0.9) 0%, rgba(129, 106, 199, 0.9) 100%), url("/img/1.jpg") center/cover fixed',
      ...
      >
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            Empower your technical skills, master advanced animations, or start
            young with our certified learning courses.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="text-center mb-5">
            <div className="d-flex align-items-center justify-content-center gap-3 flex-wrap mb-2">
              <span
                className="badge bg-purple px-3 py-2 text-white"
                style={{
              ...
              <h2 className="section-title mb-0">Kids Coding Academy</h2>
            </div>
            <p className="text-muted small mt-2">
              Nurturing mathematical logic and creative problem-solving in
              children aged 6 to 15.
            </p>
          </div>

          <div
            className="glass-panel p-lg-5 p-4 rounded-4 shadow-sm text-start"
            style={{
              background:
                "linear-gradient(135deg, rgba(77, 30, 163, 0.05) 0%, rgba(255, 64, 129, 0.05) 100%)",
          ...
          >
            <div className="row g-4 align-items-center">
              <div className="col-lg-7">
                <div className="d-flex align-items-center gap-2 mb-3">
                  ...
                  <h4
                    ...
                    style={{
                      ...
                      background:
                        "linear-gradient(45deg, var(--main-color), #ff4081)",
                ...
                <p
                  className="lead text-dark fw-normal mb-4"
                  style={{ lineHeight: "1.8", fontSize: "1.1rem" }}
                >
                  Unlock your child's computational thinking! In this highly
                  interactive academy course, young creators learn the absolute
                  fundamentals of software development using Google and MIT's
                  drag-and-drop Scratch visual code blocks.
                </p>
                <div
                  className="row g-3 mb-4 text-secondary"
                  style={{ fontSize: "0.92rem" }}
                >
                  <div className="col-md-6 d-flex align-items-start gap-2">
                    <span className="text-success fw-bold">✓</span>
                    <span>
                      Create interactive 2D arcade games and animations
                    </span>
                  </div>
                  <div className="col-md-6 d-flex align-items-start gap-2">
                    <span className="text-success fw-bold">✓</span>
                  ...
                  <div className="col-md-6 d-flex align-items-start gap-2">
                    <span className="text-success fw-bold">✓</span>
                    <span>
                      Master mathematical logic and creative problem-solving
                    </span>
                  </div>
                  <div className="col-md-6 d-flex align-items-start gap-2">
                    <span className="text-success fw-bold">✓</span>
                    <span>
                      1-on-1 expert tutor guidance with micro-portfolios
                    </span>
                  </div>
                </div>
              ...
              <div className="col-lg-5 text-center">
                ...
                >
                  ...
                  <div className="my-3 text-center">
                    <span
                      className="display-6 fw-extrabold"
                      style={{
                    ...
                    <p className="text-muted mt-2 small">
                      Building the developers of tomorrow, today.
                    </p>
                  </div>
                  <hr />
                  <div className="d-flex justify-content-around text-center mt-3">
                    <div>
                      ...
                      <span className="badge bg-light text-dark py-2 px-3 border rounded-pill">
                        Beginner
                      </span>
                    </div>
                    <div>
      ...
      >
        <div className="container">
          <div className="text-center mb-5">
            <div className="d-flex align-items-center justify-content-center gap-3 flex-wrap mb-2">
              ...
              <h2 className="section-title mb-0">
                Professional Career Bootcamps
              </h2>
            </div>
            <p className="text-muted small mt-2">
              Accelerated industry-aligned paths for engineers, college
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div
              className="col-lg-4 col-md-6 d-flex animate__animated animate__zoomIn"
              style={{ animationDelay: "0.1s" }}
            >
              <div
                className="interactive-card p-4 d-flex flex-column text-start w-100 bg-white"
                style={{ borderTop: "4px solid #ff4081" }}
              >
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <span
                    className="badge bg-danger text-white px-2.5 py-1.5"
                ...
                >
                  Master modern web engineering. Design scalable user interfaces
                  in React, configure RESTful backends in Node & Express, and
                  manage document databases with MongoDB.
                </p>
                <div
                  className="p-3 bg-light rounded-3 mb-4"
                  style={{ fontSize: "0.82rem" }}
                >
                  <span className="fw-bold text-secondary d-block mb-1.5">
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <span
                    className="badge bg-info text-dark px-2.5 py-1.5"
                    style={{
                      fontSize: "0.7rem",
                      borderRadius: "15px",
                ...
                <p
                  ...
                  style={{ lineHeight: "1.6" }}
                >
                  Learn the world's most versatile language. From core coding
                  syntax and lists to writing automated scrapers and integrating
                  open AI models.
                </p>
                <div
                  className="p-3 bg-light rounded-3 mb-4"
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <span
                    className="badge bg-primary text-white px-2.5 py-1.5"
                    style={{ fontSize: "0.7rem", borderRadius: "15px" }}
                  >
                    💻 Highly Requested
                  </span>
                ...
                <p
                  ...
                  style={{ lineHeight: "1.6" }}
                >
                  Develop secure enterprise backend services. Build robust OOP
                  infrastructures, handle databases through Hibernate & JDBC,
                  and configure Spring Boot microservices.
                </p>
                <div
                  className="p-3 bg-light rounded-3 mb-4"
                  style={{ fontSize: "0.82rem" }}
        ...
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="section-title mb-2">
              Government & Academy Certificate Courses
            </h2>
            <p className="text-muted small">
              Explore our professional training catalog featuring 23 dedicated
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    borderRadius: "20px",
                    backgroundColor:
                      selectedCategory === cat ? "var(--main-color)" : "white",
                    color:
                      selectedCategory === cat ? "white" : "var(--main-color)",
                    border:
              ...
              <div key={course.id} className="col-lg-4 col-md-6 d-flex">
                ...
                >
                  ...
                  <div className="d-flex align-items-center gap-2 mb-2 mt-2">
                    <span
                      className="d-flex align-items-center justify-content-center fw-bold text-white small"
                      style={{
                        width: "28px",
                        height: "28px",
                        borderRadius: "50%",
                  ...
                  <div className="mb-4 pt-3 border-top flex-grow-1">
                    <h6 className="fw-semibold text-muted small mb-2 d-flex align-items-center gap-1">
                      <BookOpen size={14} /> Skills Taught:
                    </h6>
                    <p
                      className="text-secondary small mb-0 fw-medium"
            ...
            {filteredCourses.length === 0 && (
              <div className="col-12 py-5 text-center text-muted glass-panel rounded-4">
                <p className="fs-5 mb-0">
                  No certificate courses found matching your criteria.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="container py-4">
          <div className="row g-4 align-items-center">
            <div className="col-lg-8 text-start">
              ...
              >
                Interested in Custom Group Training?
              </h3>
              <p className="text-muted mb-0" style={{ lineHeight: "1.8" }}>
                We provide corporate training, customized college workshops, and
                group admissions for institutions. Get in touch with our academy
                heads today to design a custom syllabus that fits your technical
                criteria.
              </p>
            </div>
            <div className="col-lg-4 text-lg-end text-center">
              <a
                href="https://wa.me/919790155384?text=Hi%20Saishnaa%20Team%2C%20I%20have%20an%20inquiry%20regarding%20custom%20group%20technical%20training."
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn-purple py-3 px-4 rounded-pill fw-bold text-white d-inline-flex align-items-center gap-2"
              >
