...
export default function Chatbot() {
  ...
  const simulateBotResponse = (userText) => {
    ...
    setTimeout(() => {
      ...
      if (chatState === "asking_email") {
        if (text.includes("@") && text.includes(".")) {
          ...
          const leads = JSON.parse(
            localStorage.getItem("saishnaa_leads") || "[]",
          );
          ...
          botReply =
            "Hmm, that doesn't look like a valid email address. Could you please double-check and enter a correct email? (e.g. name@company.com)";
        }
      ...
      if (
        ...
        botReply =
          "At Saishnaa, we actively contribute to state-of-the-art technological progress. Our dedicated R&D division regularly publishes academic papers, technical journals, and architectural whitepapers focusing on AI models, high-concurrency cloud systems, and responsive web paradigms.";
        addMessage("bot", botReply);
        setTimeout(() => {
          addMessage(
            "bot",
            "Would you like to browse our latest academic research and publications?",
          );
        }, 600);
      } else if (
        ...
        botReply =
          "I would be absolutely delighted to help secure a technical consultation for your project with our lead software engineers and architects. 🗓️ To initiate this scheduling, could you please share your professional email address below?";
        addMessage("bot", botReply);
        ...
        botReply =
          "Greetings! Welcome to Saishnaa Software Solutions. I am Sai, your dedicated Technology Consultant. How may I assist you with your digital transformation, custom software architecture, or career goals today?";
        addMessage("bot", botReply);
      } else {
        botReply =
          "Thank you for sharing your message. I have successfully logged your query in our local database. To speak directly with our executive consultants or secure a customized quote, please type 'Book Consultation', email us at saishnaa@gmail.com, or send an instant WhatsApp query to +91 9790155384!";
        addMessage("bot", botReply);
      }
    }, 1200);
  };
  ...
  const quickReplies = [
    ...
    { label: "🎓 Academy Courses", text: "Tell me about your academy courses" },
              ...
              <div key={msg.id} className={`chatbot-bubble ${msg.sender}`}>
                ...
                {msg.text.includes("full Services catalog?") && (
                  <button
                    ...
                    className="btn btn-sm btn-purple mt-2 text-white w-100"
                ...
                {msg.text.includes(
                  "latest academic research and publications?",
                ) && (
                  <button
                    onClick={() => {
                      setIsOpen(false);
                ...
                {msg.text.includes("full Learning Academy Courses page?") && (
                  <button
                    onClick={() => {
                      setIsOpen(false);
                      navigate("/courses");
